  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'system',
      content: 'Bonjour ! Je suis votre assistant IA pour créer des personnages manga. Décrivez-moi le personnage que vous souhaitez créer.',
      timestamp: new Date()
    }
  ])
    ...
    try {
      ...
      if (character) {
        const assistantMessage: Message = {
          ...
          type: 'assistant',
          content: 'Voici votre personnage ! Que pensez-vous du résultat ?',
          character,
          timestamp: new Date()
        }
