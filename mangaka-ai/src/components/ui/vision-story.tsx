            ...
            <div className="flex gap-4 flex-col">
              ...
              <div className="flex gap-3 flex-col">
                <h2 className="text-3xl lg:text-4xl tracking-tight max-w-xl text-left font-comic font-bold text-white">
                  Votre imagination mérite d'être vue
                </h2>
                <p className="text-base lg:text-lg leading-relaxed tracking-tight text-gray-300 max-w-xl text-left">
                  Pendant des décennies, créer un manga était réservé à une élite.
                  Nous changeons cela. Aujourd'hui, chaque histoire compte.
                </p>
              </div>
            </div>
            <div className="grid lg:pl-4 grid-cols-1 gap-6">
              <div className="flex flex-row gap-4 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-white font-semibold text-base">Libérez votre créativité</p>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Transformez vos histoires en manga épiques sans barrière technique.
                  </p>
                </div>
              </div>
              <div className="flex flex-row gap-4 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-white font-semibold text-base">L'art au service de tous</p>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Notre IA comprend vos idées et les transforme en art manga authentique.
                  </p>
                </div>
              </div>
              <div className="flex flex-row gap-4 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-white font-semibold text-base">Rejoignez la révolution</p>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Plus de 1200 créateurs nous font déjà confiance. Pourquoi pas vous ?
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative w-full h-80 lg:h-96 rounded-xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Interface de création manga avec Mangaka AI"
                fill
