    ...
    <div className="h-screen flex bg-gray-900 text-gray-100 font-mono">
      ...
      <div className="w-64 bg-gray-800 border-r border-gray-700 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-700">
          ...
          >
            <span>Characters ({document.characters.length})</span>
          ...
          {showCharacters && (
            <div className="mt-2 space-y-1">
              ...
              {document.characters.length === 0 && (
                <div className="text-xs text-gray-500 italic">No characters detected</div>
              )}
            </div>
          )}
        </div>
...
PANEL 2
(New action)
OTHER_CHARACTER: Other dialogue
...
...`}
            ...
            {/* [FR-UNTRANSLATED: Overlay pour la coloration syntaxique] */}
